...
def get_symbol(num_classes, **kwargs):
    use_global_stats = kwargs['use_global_stats'] if 'use_global_stats' in kwargs else False
    multiplier = kwargs['multiplier'] if 'multiplier' in kwargs else 1.0

    data = mx.symbol.Variable(name='data')
    conv1 = mx.symbol.Convolution(name='conv1', data=data , num_filter=int(multiplier*32), pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True)
    ...
    conv2_1_dw = mx.symbol.Convolution(name='conv2_1_dw', data=relu1 , num_filter=int(multiplier*32), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*32))
    ...
    conv2_1_sep = mx.symbol.Convolution(name='conv2_1_sep', data=relu2_1_dw , num_filter=int(multiplier*64), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv2_2_dw = mx.symbol.Convolution(name='conv2_2_dw', data=relu2_1_sep , num_filter=int(multiplier*64), pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True, num_group=int(multiplier*64))
    ...
    conv2_2_sep = mx.symbol.Convolution(name='conv2_2_sep', data=relu2_2_dw , num_filter=int(multiplier*128), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv3_1_dw = mx.symbol.Convolution(name='conv3_1_dw', data=relu2_2_sep , num_filter=int(multiplier*128), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*128))
    ...
    conv3_1_sep = mx.symbol.Convolution(name='conv3_1_sep', data=relu3_1_dw , num_filter=int(multiplier*128), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    # 56x56 -> 28x28
    conv3_2_dw = mx.symbol.Convolution(name='conv3_2_dw', data=relu3_1_sep , num_filter=int(multiplier*128), pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True, num_group=int(multiplier*128))
    ...
    conv3_2_sep = mx.symbol.Convolution(name='conv3_2_sep', data=relu3_2_dw , num_filter=int(multiplier*256), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_1_dw = mx.symbol.Convolution(name='conv4_1_dw', data=relu3_2_sep , num_filter=int(multiplier*256), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*256))
    ...
    conv4_1_sep = mx.symbol.Convolution(name='conv4_1_sep', data=relu4_1_dw , num_filter=int(multiplier*256), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    # 28x28 -> 14x14
    conv4_2_dw = mx.symbol.Convolution(name='conv4_2_dw', data=relu4_1_sep , num_filter=int(multiplier*256), pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True, num_group=int(multiplier*256))
    ...
    conv4_2_sep = mx.symbol.Convolution(name='conv4_2_sep', data=relu4_2_dw , num_filter=int(multiplier*512), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_1_dw = mx.symbol.Convolution(name='conv5_1_dw', data=relu4_2_sep , num_filter=int(multiplier*512), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*512))
    ...
    conv5_1_sep = mx.symbol.Convolution(name='conv5_1_sep', data=relu5_1_dw , num_filter=int(multiplier*512), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_2_dw = mx.symbol.Convolution(name='conv5_2_dw', data=relu5_1_sep , num_filter=int(multiplier*512), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*512))
    ...
    conv5_2_sep = mx.symbol.Convolution(name='conv5_2_sep', data=relu5_2_dw , num_filter=int(multiplier*512), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_3_dw = mx.symbol.Convolution(name='conv5_3_dw', data=relu5_2_sep , num_filter=int(multiplier*512), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*512))
    ...
    conv5_3_sep = mx.symbol.Convolution(name='conv5_3_sep', data=relu5_3_dw , num_filter=int(multiplier*512), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_4_dw = mx.symbol.Convolution(name='conv5_4_dw', data=relu5_3_sep , num_filter=int(multiplier*512), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*512))
    ...
    conv5_4_sep = mx.symbol.Convolution(name='conv5_4_sep', data=relu5_4_dw , num_filter=int(multiplier*512), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_5_dw = mx.symbol.Convolution(name='conv5_5_dw', data=relu5_4_sep , num_filter=int(multiplier*512), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*512))
    ...
    conv5_5_sep = mx.symbol.Convolution(name='conv5_5_sep', data=relu5_5_dw , num_filter=int(multiplier*512), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    # 14x14 -> 7x7
    conv5_6_dw = mx.symbol.Convolution(name='conv5_6_dw', data=relu5_5_sep , num_filter=int(multiplier*512), pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True, num_group=int(multiplier*512))
    ...
    conv5_6_sep = mx.symbol.Convolution(name='conv5_6_sep', data=relu5_6_dw , num_filter=int(multiplier*1024), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv6_dw = mx.symbol.Convolution(name='conv6_dw', data=relu5_6_sep , num_filter=int(multiplier*1024), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(multiplier*1024))
    ...
    conv6_sep = mx.symbol.Convolution(name='conv6_sep', data=relu6_dw , num_filter=int(multiplier*1024), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
